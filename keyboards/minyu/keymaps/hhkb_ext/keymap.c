...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-----------------------------------------------------------|
     * |LShift |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /|RShift|RFn |  RShift/RFn = Up/Del
     * |-----------------------------------------------------------|
     * |LFn |LAlt|LGui |          Space          |RGui |RAlt |RCtrl|  RGui/RAlt/RCtrl = Left/Down/Right
     * `-----------------------------------------------------------'
     */
    [_BL] = LAYOUT_60_tsangan_hhkb(
        ...
        KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, MT(MOD_RSFT, KC_UP), LT(_RFN, KC_DEL),
        MO(_LFN), KC_LALT, KC_LGUI, KC_SPC, MT(MOD_RGUI, KC_LEFT), MT(MOD_RALT, KC_DOWN), MT(MOD_RCTL, KC_RGHT)),
